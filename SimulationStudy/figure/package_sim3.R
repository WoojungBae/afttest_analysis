...
save.image("C:/Users/WooJung/Documents/Rproject/afttest_analysis/SimulationStudy/figure/sim3.RData")

# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
cairo_ps("sim3_omni_mns_unstd.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_omni_mns,std="unstd")
dev.off()
cairo_ps("sim3_omni_mns_std.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_omni_mns,std="std")
dev.off()
cairo_ps("sim3_link_mns_unstd.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_link_mns,std="unstd")
dev.off()
cairo_ps("sim3_link_mns_std.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_link_mns,std="std")
dev.off()
cairo_ps("sim3_form_mns_unstd.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_form_mns,std="unstd")
dev.off()
cairo_ps("sim3_form_mns_std.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_form_mns,std="std")
dev.off()

cairo_ps("sim3_omni_mis_unstd.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_omni_mis,std="unstd")
dev.off()
cairo_ps("sim3_omni_mis_std.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_omni_mis,std="std")
dev.off()
cairo_ps("sim3_link_mis_unstd.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_link_mis,std="unstd")
dev.off()
cairo_ps("sim3_link_mis_std.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_link_mis,std="std")
dev.off()
cairo_ps("sim3_form_mis_unstd.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
afttestplot(result_form_mis,std="unstd")
dev.off()
cairo_ps("sim3_form_mis_std.eps",onefile=F,height=4,width=8, fallback_resolution = 600)
