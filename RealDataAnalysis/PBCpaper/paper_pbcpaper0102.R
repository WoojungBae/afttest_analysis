...
# ------------------------------------ omni ------------------------------------
result01_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
result01_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
result01_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="bili")
...
result01_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="prot")
...
result01_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="albu")
...
result01_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="age")
...
# ------------------------------------ omni ------------------------------------
result02_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
result02_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
result02_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="log_bili")
...
result02_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="prot")
...
result02_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="albu")
...
result02_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mns",form="age")
...
# ------------------------------------ omni ------------------------------------
result01_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
result01_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
result01_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="bili")
...
result01_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="prot")
...
result01_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="albu")
...
result01_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
result02_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
result02_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
result02_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="log_bili")
...
result02_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="prot")
...
result02_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="albu")
...
result02_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edem,path=path,pathsave=50,testType="form",eqType="mis",form="age")
