...
# ------------------------------------------------------------------------------
# ----------------- Covariates: bili+prot+albu+age+edema -----------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result01_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result01_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result01_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result01_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result01_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="albu")
...
# result01_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# --------------- Covariates: log_bili+prot+albu+age+edema ---------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result02_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result02_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result02_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result02_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result02_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="albu")
...
# result02_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# --------------- Covariates: bili+log_prot+albu+age+edema ---------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result03_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result03_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result03_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result03_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result03_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="albu")
...
# result03_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# --------------- Covariates: bili+prot+log_albu+age+edema ---------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result04_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result04_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result04_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result04_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result04_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result04_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# --------------- Covariates: bili+prot+albu+log_age+edema ---------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result05_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result05_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result05_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result05_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result05_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="albu")
...
# result05_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------------------------------------------------
# ------------- Covariates: log_bili+log_prot+albu+age+edema -------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result06_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result06_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result06_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result06_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result06_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="albu")
...
# result06_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# ------------- Covariates: log_bili+prot+log_albu+age+edema -------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result07_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result07_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result07_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result07_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result07_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result07_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# ------------- Covariates: log_bili+prot+albu+log_age+edema -------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result08_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result08_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result08_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result08_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result08_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="albu")
...
# result08_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------------------------------------------------
# ------------- Covariates: bili+log_prot+log_albu+age+edema -------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result09_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result09_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result09_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result09_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result09_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result09_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# ------------- Covariates: bili+log_prot+albu+log_age+edema -------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result10_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result10_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result10_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result10_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result10_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="albu")
...
# result10_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------------------------------------------------
# ------------- Covariates: bili+prot+log_albu+log_age+edema -------------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result11_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result11_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result11_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result11_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result11_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result11_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------------------------------------------------
# ----------- Covariates: log_bili+log_prot+log_albu+age+edema -----------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result12_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result12_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result12_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result12_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result12_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result12_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mns",form="age")
...
# ------------------------------------------------------------------------------
# ----------- Covariates: log_bili+log_prot+albu+log_age+edema -----------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result13_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result13_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result13_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result13_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result13_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="albu")
...
result13_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------------------------------------------------
# ----------- Covariates: log_bili+prot+log_albu+log_age+edema -----------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result14_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result14_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result14_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result14_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="prot")
...
# result14_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result14_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------------------------------------------------
# ----------- Covariates: bili+log_prot+log_albu+log_age+edema -----------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result15_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result15_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result15_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="bili")
...
# result15_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result15_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result15_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------------------------------------------------
# --------- Covariates: log_bili+log_prot+log_albu+log_age+edema ---------
# ------------------------------------------------------------------------------

# ------------------------------------ omni ------------------------------------
# result16_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mns")
...
# ------------------------------------ link ------------------------------------
# result16_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="link",eqType="mns")
...
# ------------------------------------ form ------------------------------------
# result16_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_bili")
...
# result16_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_prot")
...
# result16_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_albu")
...
# result16_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mns",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result01_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result01_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result01_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result01_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result01_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result01_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result02_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result02_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result02_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result02_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result02_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result02_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result03_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result03_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result03_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result03_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result03_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result03_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result04_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result04_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result04_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result04_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result04_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result04_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result05_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result05_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result05_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result05_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result05_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result05_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result06_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result06_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result06_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result06_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result06_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result06_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result07_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result07_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result07_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result07_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result07_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result07_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result08_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result08_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result08_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result08_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result08_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result08_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result09_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result09_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result09_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result09_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result09_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result09_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result10_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result10_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result10_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result10_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result10_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result10_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result11_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result11_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result11_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result11_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result11_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result11_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result12_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result12_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result12_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result12_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result12_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result12_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+age+edema,path=path,testType="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
# result13_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result13_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result13_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result13_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result13_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="albu")
...
# result13_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result14_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result14_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result14_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result14_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="prot")
...
# result14_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result14_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result15_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result15_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result15_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="bili")
...
# result15_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result15_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result15_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------ omni ------------------------------------
# result16_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
# result16_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
# result16_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_bili")
...
# result16_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_prot")
...
# result16_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_albu")
...
# result16_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_prot+log_albu+log_age+edema,path=path,testType="form",eqType="mis",form="log_age")
...
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
beta01mns = aftsrr(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,eqType="mns",se="ISMB")
beta01mis = aftsrr(Surv(X_pbc,D_pbc)~bili+prot+albu+age+edema,eqType="mis",se="ISMB")
summary(beta01mns)
summary(beta01mis)

beta02mns = aftsrr(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,eqType="mns",se="ISMB")
beta02mis = aftsrr(Surv(X_pbc,D_pbc)~log_bili+prot+albu+age+edema,eqType="mis",se="ISMB")
summary(beta02mns)
summary(beta02mis)

beta06mns = aftsrr(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,eqType="mns",se="ISMB")
beta06mis = aftsrr(Surv(X_pbc,D_pbc)~log_bili+log_prot+albu+age+edema,eqType="mis",se="ISMB")
summary(beta06mns)
summary(beta06mis)
